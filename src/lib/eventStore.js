...
module.exports = new EventStore()
	...
	.addEvent('configUpdateEntry', 'oldEntry, newEntry, path', 'Emitted when Configuration.updateOne, Configuration.updateArray or Configuration.reset is run.')
	.addEvent('configDeleteEntry', 'entry', 'Emitted when Gateway.deleteEntry is run.')
	.addEvent('configCreateEntry', 'entry', 'Emitted when Gateway.createEntry is run or when Gateway.getEntry with the create parameter set to true creates the entry.')
